const CONFIG = {
    mainQuestion: "HYYY BAEBAAAA",
    subQuestion: "Please say yes ",
    yesButton: "HYYY JUGA BAEBAAAA",
    noButton: "APASIH",
    noEscapeTexts: ["nononono ya😝", "gabisa dipencet wle😜", "woff uuu somuch 💕"],
    confirmTitle: "YEAAAY! Dipencett 💗",
    confirmText: "apa nyak…",
    badgeText: "aku gatau mau ngomong apa disini jujur....",
    nextButton: "Next ",
    repeatButton: "Repeat",
    flowerTitle: "This lily flower is for a beautiful soul like you BAEBAAAA ⋆｡‧˚ʚɞ˚‧｡⋆",
    takeBouquetButton: "Take the Bouquet ",
    bouquetMessage: "Yeay! Now its Yours 💕",
    nextFlowerButton: "Next ",
    collageTitle: "Gallery of You (Cuma punya foto ini doang sih hehe)",
    collageSubtitle: "Even though we just met, we've already spent quite a lot of time together (laughs). 💕",
    nextCollageButton: "Just one more page… ",
    finalTitle: "WOOFF UU SOMUCHH BAEBAA 💞",
    finalMessage: `terima kasih udah jadi rumah yang selalu bikin aku pengen pulang.
💕 
                         hheheheheheheh 💕💕`,
